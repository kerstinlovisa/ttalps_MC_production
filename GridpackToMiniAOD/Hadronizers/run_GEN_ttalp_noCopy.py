...
# with command line options: Configuration/GenProduction/python/fragment.py --mc --eventcontent RAWSIM,LHE --datatier GEN,LHE --conditions 106X_upgrade2018_realistic_v4 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN --geometry DB:Extended --era Run2_2018 --filein file:step-1.root --fileout file:step0.root
import os
import sys
import random
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(random.randint(0, 900000000))
